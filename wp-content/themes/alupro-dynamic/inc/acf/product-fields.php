...
acf_add_local_field_group(array(
	...
	'fields' => array(
		...
		array(
			'key' => 'field_prod_use_catalog_pdf',
			'label' => __('Use Uploaded PDF Catalog', 'alupro-dynamic'),
			'name' => 'product_use_catalog_pdf',
			'type' => 'true_false',
			'instructions' => __('Enable to show and download the uploaded PDF catalog instead of the dynamic table.', 'alupro-dynamic'),
			'default_value' => 0,
			'ui' => 1,
			'ui_on_text' => __('Enabled', 'alupro-dynamic'),
			'ui_off_text' => __('Disabled', 'alupro-dynamic'),
			'wrapper' => array('width' => '50%'),
		),
		array(
